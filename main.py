...
def detect():
    ...
    # video_address = 'http://192.168.0.227:4747/video'
    video_address = 'http://192.168.0.227:4747/video/mjpeg.jpg?x.mjpeg'
...
thread1 = Thread(target=detect, args=(), daemon=True)
thread1.start()
sleep(3)
rtsp_stream()